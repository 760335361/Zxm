  ...
  return defineConfig({
    ...
    resolve: {
      alias: {
        ...
        // ==================== 新增代码 ====================
        // 解决 element-plus 路径解析问题
        // 'element-plus': path.resolve(__dirname, 'node_modules/element-plus/lib/index.js'),
        // ==================================================
      },
    },
    server: {
      host: '0.0.0.0', // 新增：允许局域网通过本地IP访问
      port: 3001,
      open: true,
      proxy: {
        '/api': {
          ...
          rewrite: path => path.replace(/^\/api/, ''),
            ...
            // 👇 只加这2行！不改动其他配置
      hmr: false, // 禁用Vite热更新的WebSocket
      watch: { usePolling: false } // 关闭文件轮询监听
    },
    esbuild: false,
    build: {
      terserOptions: {
